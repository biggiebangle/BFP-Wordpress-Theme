...
<html lang="en">
  <head>
    ...
    <?php wp_head(); ?>
    <?php //these scripts need to be integrated into the functions.php file ?>
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.3.15/angular.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.15/angular-animate.min.js"></script>
    <script src="/wp-content/themes/bfp/js/shop.js"></script>
    
     <link rel='stylesheet' id=''  href='../wp-content/themes/bfp/css/store.css' type='text/css' media='all' />
